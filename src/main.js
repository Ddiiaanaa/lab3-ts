...
async function renderCatalog() {
    ...
    try {
        ...
        html += '</div>';
        html += `<button id="specials-btn" class="btn btn-warning">Specials</button>`;
...
async function renderCategoryItems(categoryShortname, categoryName) {
    appContent.innerHTML = '<p>Завантаження товарів...</p>';
    try {
        const products = await fetchData(`./data/${categoryShortname}.json`);
